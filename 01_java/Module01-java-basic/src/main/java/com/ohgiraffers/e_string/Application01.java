...
public class Application01 {
    public static void main(String[] args) {
        ...
        System.out.println("이름이 같은지 == " + (lee==lee1)); //false
        System.out.println("euqals 이름이 같은지 == " + (lee.equals(lee1))); //true

        //equals가 Object로 받는 이유
        //어떤 객체가 올지 모르니까. 여기서 this는 뭐냐? 나랑 같냐? 내가 들어간거임 true 리턴
        //숫자값으로 치환된다.???
    }
}
